...
ChatBot &ChatBot::operator=(const ChatBot &source) {
    std::cout << "[ChatBot] ASSIGNING content of instance " << &source
              << " to instance " << this << std::endl;
...
ChatBot::ChatBot(ChatBot &&source) {
    std::cout << "[ChatBot] MOVING instance " << &source << " to instance "
              << this << std::endl;
    ...
    // update _chatBot pointer on _chatLogic
...
ChatBot &ChatBot::operator=(ChatBot &&source) {
    std::cout << "[ChatBot] MOVE ASSIGNING instance " << &source
              << " to instance " << this << std::endl;
